...
def patient_wise_loader_outputs(model, dataset, patient_indices, device):
    """Aggregate model outputs to patient level using min output rule."""
    model.eval()
    patient_scores = []
    patient_labels = []
    with torch.no_grad():
